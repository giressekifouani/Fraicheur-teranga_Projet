...
@Component({
  selector: 'app-panier',
  templateUrl: './panierbis.page.html',
  styleUrls: ['./panierbis.page.scss'],
})
export class PanierbisPage implements OnInit {
//@Input() slides: any[] = []
...
//item : any;
  ...
  items = [
    { id: 1, img: 'assets/ImageFruit/Patates.png', title: 'Tomate', subtitle: 'Subtitle 1', content: 'Le garder dans un endroit frais, sec, et à l’abri de la lumière.', price: 7000  },
    { id: 2, img: 'assets/ImageFruit/Pêche.png', title: 'Fraise', subtitle: 'Subtitle 2', content: 'Jus pressé de fraise', price: 5000 },
    { id: 4, img: 'assets/ImageFruit/Poivrons.png', title: 'Légumes ', subtitle: 'Subtitle 3', content: 'Une fois coupé ou cuit il perd progressivement ses vitamines.', price: 3000 },
    ...
    { id: 4, img: 'assets/ImageFruit/Poivrons (2).png', title: 'Ananas', subtitle: 'Subtitle 3', content: 'Sensible au froid (-7°C) et aux chocs Pour accélérer sa maturité, enveloppez-le dans du papier kraft', price: 2500},


    { id: 5, img: 'assets/ImageFruit/Tomates.png', title: 'Brocoli', subtitle: 'Subtitle 3', content: 'Une fois coupé ou cuit il perd progressivement ses vitamines', price: 2000 },
