...
//item : any;
  ...
  itemsBis = [
    { id: 41, img: 'assets/ImageFruit/112913160.jpg', title: 'Radis noir', subtitle: 'Subtitle 3', content: 'Melon', price: 2500},
  ...
  items1 = [
    { id: 1, img: 'assets/ImageFruit/Patates.png', title: 'Légumes', subtitle: 'Subtitle 1', content: 'Le garder dans un endroit frais, sec, et à l’abri de la lumière.', price: 7000  },
    { id: 2, img: 'assets/ImageFruit/Pêche.png', title: 'Fruits', subtitle: 'Subtitle 2', content: 'Jus pressé de fraise', price: 5000 },

  ]

  items = [
    { id: 1, img: 'assets/ImageFruit/Ananas.png', title: 'Ananas', subtitle: 'Subtitle 1', content: 'Le garder dans un endroit frais, sec, et à l’abri de la lumière.', price: 7000  },
    { id: 2, img: 'assets/ImageFruit/Pêche.png', title: 'Fraise', subtitle: 'Subtitle 2', content: 'Jus pressé de fraise', price: 5000 },
    { id: 4, img: 'assets/ImageFruit/Passion.png', title: 'Légumes ', subtitle: 'Subtitle 3', content: 'Une fois coupé ou cuit il perd progressivement ses vitamines.', price: 3000 },
    { id: 3, img: 'assets/ImageFruit/Poire.png', title: 'Fruit', subtitle: 'Subtitle 3', content: 'Sensible au froid (-7°C) et aux chocs Pour accélérer sa maturité, enveloppez-le dans du papier kraft', price: 2500},
    { id: 4, img: 'assets/ImageFruit/Pommes.png', title: 'Pomme', subtitle: 'Subtitle 3', content: 'Sensible au froid (-7°C) et aux chocs Pour accélérer sa maturité, enveloppez-le dans du papier kraft', price: 2500},


    { id: 5, img: 'assets/ImageFruit/Mangue.png', title: 'Mangue', subtitle: 'Subtitle 3', content: 'Une fois coupé ou cuit il perd progressivement ses vitamines', price: 2000 },
    { id: 6, img: 'assets/ImageFruit/Madd.png', title: 'Madd ', subtitle: 'Subtitle 3', content: 'Conserver dans une boîte hermétique', price: 1500 },
    ...
    { id: 9, img: 'assets/ImageFruit/Corossol.png', title: 'Corossol', subtitle: 'Subtitle 3', content: 'Navet', price: 1000 },
    ...
    { id: 11, img: 'assets/ImageFruit/Melon.png', title: 'Melon', subtitle: 'Subtitle 3', content: 'Consommez le fruit immédiatement une fois ouvert sans quoi la pulpe asseche', price: 2500},
    { id: 12, img: 'assets/ImageFruit/Orange.png', title: 'Orange', subtitle: 'Subtitle 3', content: 'Conservez dans un sachet à trous ou dans une boîte hermétique', price: 3000 },
    ...
    { id: 15, img: 'assets/ImageFruit/Banane.jpg', title: 'Banane', subtitle: 'Subtitle 3', content: 'Aubergine ', price: 2000 },
    { id: 16, img: 'assets/ImageFruit/Melon2.jpg', title: 'Haricot', subtitle: 'Subtitle 3', content: 'Melon jaune', price: 1500 },
